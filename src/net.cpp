...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Magnetocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"magnetocoin.com", "magnetoseeder.magnetocoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"magnetocoin.com", "magnetotestnet.magnetocoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Magnetocoin is probably already running."), addrBind.ToString().c_str());
        else
